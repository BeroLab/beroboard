		...
		<DayPicker
			...
			classNames={{
				...
				button_previous: cn(
					...
					"size-(--cell-size) select-none rounded-full p-0 aria-disabled:opacity-50",
				...
				dropdown_root: cn(
					"cn-calendar-dropdown-root relative rounded-full",
				...
				caption_label: cn(
					...
					captionLayout === "label"
						? "text-sm"
						: "cn-calendar-caption-label flex items-center gap-1 rounded-full text-sm [&>svg]:size-3.5 [&>svg]:text-muted-foreground",
	...
	return (
		<Button
			...
			className={cn(
				...
				// Rounded for all states (hover, selected, etc.)
				"rounded-full",
				// Range selection styles
				"data-[range-start=true]:rounded-r-none data-[range-start=true]:rounded-l-full",
