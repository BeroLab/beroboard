...
import { type CreateBoardDTO, useCreateBoard } from "@/modules/boards/services/create-board";
      ...
      >
         <div className="grid gap-4">
            ...
            <div className="grid gap-3">
               ...
               />
               <p className="text-gray-500 text-sm">Pressione enter para adicionar mais estágios. Você pode editar os estágios mais tarde.</p>
            </div>
